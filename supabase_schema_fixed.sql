...
-- Fixed version with proper RLS policies for backend service
...
-- Create new policies that allow service_role and anon access
-- These policies allow backend services to operate without authentication
...
-- Note: For production, you should use the SERVICE_ROLE key in your backend
-- and implement proper authentication/authorization at the application level
